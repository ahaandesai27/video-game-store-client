...
export default function Navbar () { 
    ...
    return <nav className="bg-purple-950 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-purple-950 overflow-y-hidden">
    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a className="flex items-center">
            <span className="self-center text-xl font-semibold whitespace-nowrap text-white dark:text-white">GameShop</span>
        </a>
        ...
        <div className="flex items-center lg:order-2">
            ...
            {verified ? 
            (<>
                <button className="bg-purple-500 text-white font-bold py-1 px-3 rounded-full" onClick={() => navigate('/profile')}>
                    <div className="flex">
            ...
            (<>
                <button onClick={() => {navigate('/login')}} className="text-white-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log in</button>
